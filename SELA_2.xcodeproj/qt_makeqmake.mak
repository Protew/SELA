...
QMAKE    = /usr/bin/qmake
SELA_2.xcodeproj/project.pbxproj: SELA_2.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.7/mkspecs/macx-xcode -o SELA_2.xcodeproj/project.pbxproj SELA_2.pro
